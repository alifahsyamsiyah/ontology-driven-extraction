...
public class YourPlugin {
	 ...
	 * @return The output.
	 */
	private YourOutput yourPrivatePlugin(PluginContext context, String input1, String input2, YourConfiguration configuration) {
	...
	public YourOutput yourConfiguredPlugin(PluginContext context, String input1, String input2, YourConfiguration configuration) {
	...
	public YourOutput yourDefaultPlugin(UIPluginContext context, String input1, String input2) {
		// Get the default configuration.
	    YourConfiguration configuration = new YourConfiguration(input1, input2);
